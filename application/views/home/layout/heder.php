                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="produk" class="nav-item nav-link active">Home</a>
                    ...
                    <?php } else { ?>
                        ...
                        <a href="<?php echo site_url('toko/index/')?>" class="nav-item nav-link">Toko</a>
                        <a href="detail.html" class="nav-item nav-link">Transaksi</a>
                    </div>
                    <div class="navbar-nav ml-auto py-0">
                    <a href="<?php echo site_url('member/edit/'.$this->session->userdata('idKonsumen'))?>" class="nav-item nav-link">Edit Profile</a>
