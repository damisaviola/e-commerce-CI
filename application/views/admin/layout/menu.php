<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <a href="<?php echo site_url($this->session->userdata('userName'))?>" class="d-block"><?php echo $this->session->userdata('userName');?></a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
              <a href="<?php echo site_url('adminpanel/change/'.$this->session->userdata('idAdmin'))?>" class="nav-link">
