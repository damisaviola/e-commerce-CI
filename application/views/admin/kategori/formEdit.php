    ...
    <div class="row">
        ...
        <?php 
            ...
            <div class="card card-info">
              ...
              <input type="hidden" class="form-control" value="<?php echo $kategori->idkat;?>" name="id">  
              <div class="card-body">
                  <div class="form-group row">
                    <label for="nama" class="col-sm-4 col-form-label">Nama Kategori</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" value="<?php echo $kategori->namaKat;?>" name="namaKat" id="nama" placeholder="Nama Kategori">
                    </div>
                  </div>
